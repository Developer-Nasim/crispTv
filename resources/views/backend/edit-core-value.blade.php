        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Edit Core Value</h4> 
                </div><!--end card-header-->
                <div class="card-body">
                    @if ($getDatas)
                        <form class="form-parsley" action="/admin/submit/editCoreValueData" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                            ...
                            <div class="form-group mb-0">
                                ...
                                <a href="/admin/core-values" class="btn btn-success">
                                    Cancel
                                </a>
                            </div><!--end form-group-->
                        </form><!--end form--> 
