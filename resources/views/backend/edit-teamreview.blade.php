    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    @if ($getDatas)
                        <form class="form-parsley" action="/admin/submit/editTeamReviewData" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group mb-0">
                                ...
                                <a href="/admin/team-review" class="btn btn-success">Cancel</a>
                            </div><!--end form-group-->
                        </form><!--end form--> 
                    @endif       
                </div><!--end card-body-->
