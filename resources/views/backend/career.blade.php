    ...
    <div class="row">
        <div class="col-lg-5">
            <div class="card">
                ...
                <div class="card-body">  
                    <form class="form-parsley" action="/admin/submit/CareerData" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                                    ...
                                    @if ($getDatas)
                                        @for ($i = 0; $i < count($getDatas); $i++)
                                            <tr>
                                                ...
                                                <td> 
                                                    <a href="/admin/edit/career/{{$getDatas[$i]->id}}" class="btn btn-success">Edit</a> 
                                                    <a href="/admin/delete/career/{{$getDatas[$i]->id}}" class="btn btn-danger">Delete</a> 
                                                </td> 
                                            </tr>  
                                        @endfor
                                    @endif
